...
for (let index = 0; index < matches; index++) {
  ...
  console.log(`${index + 1}/${matches} seed=${seed} acquisitions=${claims.length} teleports=0`);
}

console.log(`OK: ${matches} matches, ${acquisitions} physical acquisitions, ${passResolutions} passes resolved, zero teleports.`);
